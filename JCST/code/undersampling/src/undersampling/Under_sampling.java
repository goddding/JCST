...
public class Under_sampling {
	...
	public static void main(String agrs[]) throws Exception{
		...
		double tp, fp, fn, tn;
		String classifierName[] = { "KNN"}; //{ "NBM", "NB", "SVM", "KNN"};
		...
		for(String name:classifierName){
			...
			for (int i = 0; i < folds; i++) {
				...
				UnderSampling.underSampling(trains);	
		...
		File file=new File("E:/compsac/"+bugType+"/"+projectName+"_undersampling.txt");
